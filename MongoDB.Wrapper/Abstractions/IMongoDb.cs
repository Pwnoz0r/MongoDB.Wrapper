...
public interface IMongoDb
{
    ...
    ///     When true, items returned in evaluation of query will contain (soft) deleted entites,
    ...
    /// <summary>
    ///     Returns the entity from collection of type TEntity, that matches the predicate. If more than one entity matches the
    ///     predicate, an exception is thrown
    /// </summary>
    /// <typeparam name="TEntity">Type of entity</typeparam>
    /// <param name="predicate">Predicate to compare entities against</param>
    /// <param name="includeDeleted">When set to true, the query will also search within (soft) deleted entites</param>
    ...
    /// <summary>
    ///     Replaces the object of type TEntity with passed object, compared by IEntity.Id. If IEntity.Id equals default,
    ///     entity is added.
    ...
    /// <summary>
    ///     Reverts a soft delete (un-sets Deleted flag) of an entity with given id. Throws an exception if the entity doesn't
    ///     exist.
    /// </summary>
    /// <typeparam name="TEntity">Type of entity</typeparam>
    /// <param name="id">Id of the entity</param>
    ...
    /// <summary>
    ///     Deleted an entity with given id from the database. This is irreversible. Throws an exception if the entity doesn't
    ///     exist.
    /// </summary>
    /// <typeparam name="TEntity">Type of entity</typeparam>
    /// <param name="id">Id of the entity</param>
